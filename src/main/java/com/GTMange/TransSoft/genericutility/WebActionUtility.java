...
public class WebActionUtility {
	...
	public WebActionUtility()  {
		...
		try {
			...
			String STIMEOUT = fLib.getDataFromPropertiesFile(filepath, "TimeOut");
	 ...
	 * @throws Throwable
	 */
	public WebElement waitForElement(WebDriver driver, WebElement element) throws Throwable {
	...
	/**
	 * This method is used to scroll the element using JavaScript
	 * 
	 * @param driver
	 * @param javaScript
	 */
	public void scrollElement(WebDriver driver, String javaScript) {
		JavascriptExecutor js = (JavascriptExecutor) driver;
