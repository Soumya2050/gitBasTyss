...
public class DataBaseUtility {
	...
	public DataBaseUtility()  {
		String filepath;
		try {
			filepath = fLib.getFilePathFromPropertiesFile("DataBaseServerFilePath");
			URL = fLib.getDataFromPropertiesFile(filepath, "url");
			USERNAME = fLib.getDataFromPropertiesFile(filepath, "username");
			PASSWORD = fLib.getDataFromPropertiesFile(filepath, "password");
		} catch (IOException e) {
